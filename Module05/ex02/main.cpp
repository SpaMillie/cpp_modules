...
int main(void){
    {
        try {
            ...
            AForm form1("Shepardise", 4, 76);
            std::cout << form1 << std::endl;
            AForm form2("Legionise", 34, 1);
            std::cout << form2 << std::endl;
            AForm form3("Garrusise", 45, 90);
            std::cout << form3 << std::endl;
            AForm form4("Mirandise", 150, 7);
            std::cout << form4 << std::endl;
            // AForm form5(form3); //testing the copy cnstructor 
            ...
            // AForm form6("Gruntise", 234, 1);
            // std::cout << form6 << std::endl;
            // AForm form7("Liarise", 3, 0);
